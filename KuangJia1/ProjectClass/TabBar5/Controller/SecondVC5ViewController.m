...
@interface SecondVC5ViewController ()
...
@implementation SecondVC5ViewController
...
- (void)segmentStyle0 {
    ...
    _segHead = [[MLMSegmentHead alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 40) titles:list headStyle:_style layoutStyle:_layout];
...
- (void)segmentStyle5 {
    ...
    _segScroll = [[MLMSegmentScroll alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64) vcOrViews:[self vcArr:list.count]];
    _segScroll.loadAll = NO;
    _segScroll.showIndex = 2;
